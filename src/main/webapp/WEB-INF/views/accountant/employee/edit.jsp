...
<div class="editform">
    <main>
        <form action='/accountant/employee/update' method="post" class='form'>
            <p class='field required half focus active'>
                <input type="hidden" name="id" value="${employee.id}">
                <input type="hidden" name="name" value="${employee.name}">
                <input type="hidden" name="surname" value="${employee.surname}">
                <label class='label required' for='name'>NAME</label>
                <input class='text-input' id='name' name='name' required type='text' value="${employee.name}" disabled>
            </p>
            <p class='field required half focus active'>
                <label class='label' for='surname'>SURNAME</label>
                <input class='text-input' id='surname' name='surname' value="${employee.surname}" disabled="disabled">
            </p>
            ...
            <p class='field required half'>
                ...
                <input class='text-input' type="number" id='salary' name='salary' value="${employee.salary}">
            </p>
            <p class='field required half'>
